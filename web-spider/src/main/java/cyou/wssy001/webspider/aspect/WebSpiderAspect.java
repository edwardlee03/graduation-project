package cyou.wssy001.webspider.aspect;
...
public class WebSpiderAspect {
    private final SM2Util sm2Util;

    @Before("execution(public * cyou.wssy001.webspider.controller.ReceiveController.receive(..))")
